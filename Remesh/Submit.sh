#!/bin/bash
#SBATCH -o /work/bm1164/m300832/Buttressing/Remesh/Logs/SLURM_job.%j.%N.out
#SBATCH -e /work/bm1164/m300832/Buttressing/Remesh/Logs/SLURM_job.%j.%N.err
#SBATCH -D /work/bm1164/m300832/Buttressing/Remesh/
#SBATCH -J Remesh
#SBATCH --get-user-env
